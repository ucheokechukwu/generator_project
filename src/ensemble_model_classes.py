...
class DensePlusOnePlusConvolutionModel(Model):
    def __init__(self):
        ...
        weights = ['models/submodel_weights/InputSubModelX123/3/ckpt/checkpoint.weights.h5',
                   'models/submodel_weights/ConvolutionSubModelX4/3/ckpt/checkpoint.weights.h5',
                   'models/submodel_weights/ConvolutionSubModelX5/3/ckpt/checkpoint.weights.h5'
                  ]
